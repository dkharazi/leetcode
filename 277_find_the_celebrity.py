...
# Two pass:
#   First pass find out the celebrity candidate.
#   Second pass verify if candidate is truly a celebrity.
#
...
#         We also know the people before the current person cannot be the celebrity
#         because they know the candidate.
...
#         because the people before him/her cannot,
#         and the people after can't be either because they know the candidate.
