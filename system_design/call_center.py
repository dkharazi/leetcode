...
class Employee(metaclass=ABCMeta):
    ...
    def take_call(self, call):
        """Asume the employee will always successfully take the call"""
        self.call = call
...
class Director(Employee):
    def __init__(self, employee_id, name):
        super(Director, self).___init(employee_id, name, Rank.DIRECTOR)
...
class CallCenter(object):
    ...
    def dispatch_call(self, call):
        ...
        if call.rank == Rank.SUPERVISOR or employee == None:
            employee = self._dispatch_call(call, self.supervisors)
        if call.rank == Rank.DIRECTOR or employee == None:
